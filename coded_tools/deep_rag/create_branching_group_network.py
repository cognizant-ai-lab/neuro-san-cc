...
class CreateBranchingGroupNetwork(CodedTool):
    """
    ...
    async def async_invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Any:
        ...
        empty: Dict[str, Any] = {}
        grouping_json: Dict[str, Any] = args.get("grouping_json", empty)
        logstr: str = dumps(grouping_json, indent=4, sort_keys=True)
        logger.info("grouping_json is %s", logstr)
